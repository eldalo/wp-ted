...
<?php if ( have_comments() ): ?>
    ...
    <nav>
        <div class="comment-nav-prev"><?php previous_comments_link( __( '&larr; Previous Comments', 'ted' ) ) ?></div>
        <div class="comment-nav-next"><?php next_comments_link( __( 'More Comments &rarr;', 'ted' ) ) ?></div>
    </nav>
    <?php endif ?>
